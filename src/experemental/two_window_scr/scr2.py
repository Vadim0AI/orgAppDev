...
# Путь к скрипту 1
path_scr2 = r'/tests/experemental/two_window_scr/scr1.py'

# Путь к вашему .bat файлу для запуска скрипта 1
bat_file_path = r'/tests/experemental/two_window_scr/run_scr1.bat'
